        ...
        <div class="compile" v-show="isShowEdit">
          ...
          <div class="compile-middle">
            <el-row>
              ...
              <el-col :span="6">
                <span>部门</span>
                 <input type="text" @input="searchDeptDataChange" v-model="modelObj.DEPT_ID_NAME">
                 <div v-show="isBoxDept" @click.stop="pageDetailDeptClick"
								style="position: absolute;z-index:10;width:38%;margin-left:10.5%" class="showTable text-center">
                  <div class="tablehead" style="padding:5px 0">
                    <el-row>
                      <el-col :span="6">
                        <span>序号</span>
                      </el-col>
                  ...
                  <div class="tablefoot">
                    <div class="block pageDetailStaffClick" @click.stop="pageDetailDeptClick">
                      <el-pagination @current-change="handleCurrentChangeDetailDept" :current-page.sync="currentPageDept" :page-size="currentPageSizeDept" layout="total,prev, next, jumper" :total="searchDetailDeptDataList.total">
                      </el-pagination>
                    </div>
                  </div>
                </div>
...
.compile-middle .showTable  .el-row{
  margin: 0;padding: 0;
}
</style>
