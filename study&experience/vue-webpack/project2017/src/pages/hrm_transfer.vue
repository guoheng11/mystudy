<template>
 ...
 style="position: absolute;z-index:10;width:38%;" class="text-center">
										...
										<td>
											...
											<transition name="fold">
												<div @click.stop="pageDetailPostionClick" v-show="isDetailBoxPostion" style="position:absolute ;z-index:9999;">
													<div class="tablehead">
														<ul>
															<li class="fl tableli" style="width:200px">序号222</li>
...
export default {
	...
	data() {
		return {
			...
			detailTypeList: { total: 0, rows: [] },//调动类别对象定义
		}
	},
	// filters: {
	// },
