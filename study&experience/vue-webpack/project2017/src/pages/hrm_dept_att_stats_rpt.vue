  ...
  export default {
      ...
      methods: {
        ...
        cmdSearchList() {
          ...
          var url = this.common.baseNodeUrl+"hrm/rpt/Srv_HRM_DeptAttendStatsRpt.ashx"+param
          this.$http.get(url)                
              .then(function(res) {
        ...
        // 导出
        cmdExpExcel(){
            var url = this.common.baseNodeUrl+"hrm/rpt/Srv_HRM_DeptAttendStatsExpExcel.ashx?financeCycle="+this.currentYear+''+this.currentMonth;
            this.$http.get(url)             
              .then(function(res) {
                var dataJson = res.body;
                if(dataJson.Succeed != 1) {
